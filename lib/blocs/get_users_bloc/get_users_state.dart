...
class GetUserState extends Equatable {
  ...
  const GetUserState({required this.user, required this.getStatus,required this.message});
  GetUserState.init()
      : this(user: MyUser.defaultUser(), getStatus: GetStatus.init,message: "init");
  ...
  GetUserState.error(String message)
      : this(user: MyUser.defaultUser(), getStatus: GetStatus.error,message: message);
  @override
