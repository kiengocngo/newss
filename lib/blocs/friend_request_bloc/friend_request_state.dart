...
class FriendRequestState extends Equatable {
  ...
  const FriendRequestState.firstRequest() : this(status: FriendState.firstRequest);
  const FriendRequestState.secondRequest() : this(status: FriendState.seccondRequest);
